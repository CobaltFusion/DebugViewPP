...
#include <cassert>
#include <stdexcept>
#include "DebugViewppLib/MatchType.h"
...
{
#define MATCH_TYPE(f, id) \
    case MatchType::f: return id;
    switch (value)
    {
        MATCH_TYPES()
    default: assert(!"Unexpected MatchType"); break;
