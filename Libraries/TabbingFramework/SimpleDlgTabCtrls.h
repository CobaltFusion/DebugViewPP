...
class CButtonDlgTabCtrl : public CCustomTabCtrl<CButtonDlgTabCtrl, TItem, CStatic>
{
protected:
...
template <class TItem = CCustomTabItem>
class CFolderDlgTabCtrl : public CCustomTabCtrl<CFolderDlgTabCtrl, TItem, CStatic>
{
protected:
...
public:
	...
	{
		CXOFFSET = 8
	}; // defined pitch of trapezoid slant
	enum
	{
		CXMARGIN = 2
...
template <class TItem = CCustomTabItem>
class CSimpleDotNetDlgTabCtrl : public CCustomTabCtrl<CSimpleDotNetDlgTabCtrl, TItem, CStatic>
{
protected:
