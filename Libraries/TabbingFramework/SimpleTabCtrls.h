...
class CButtonTabCtrl : public CCustomTabCtrl<CButtonTabCtrl<TItem>, TItem>
{
protected:
...
template <class TItem = CCustomTabItem>
class CFolderTabCtrl : public CCustomTabCtrl<CFolderTabCtrl<TItem>, TItem>
{
protected:
...
template <class TItem = CCustomTabItem>
class CSimpleDotNetTabCtrl : public CCustomTabCtrl<CSimpleDotNetTabCtrl<TItem>, TItem>
{
protected:
